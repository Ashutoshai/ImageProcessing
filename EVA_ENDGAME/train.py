...
if __name__ == '__main__':
    ...
    start_timesteps = 1e4
    eval_freq = 5e3 # How often the evaluation step is performed 
    ...
    policy_noise = 0.2 # STD of Gaussian noise added to the action
    ...
    while total_timesteps < max_timesteps:
        ...
        if exploration < deviation:
            action = env.action_space_sample()
            print("deviation :", deviation, " random: action: ", action)
        else:
            action = policy.select_action((obs, (episode_actor_hx, episode_actor_cx) ))
            print("deviation :", deviation, " policy: action: ", action)
